...
public class SudokuBoard extends View {
    ...
    public SudokuBoard(Context context, @Nullable AttributeSet attrs) {
        ...
        try{
            ...
            cellsHighlightColor = a.getInteger(R.styleable.SudokuBoard_cellsHighlightColor,
                    0);
    ...
    protected void onMeasure(int width, int height){
        ...
        int dimension = Math.min(Resources.getSystem().getDisplayMetrics().widthPixels - 70,
                Resources.getSystem().getDisplayMetrics().heightPixels - 70);
    ...
    private void drawBoard(Canvas canvas){
        for(int c = 0; c < 10; c++){
            ...
            canvas.drawLine(cellSize * c,0,cellSize * c, getWidth(),
                    boardColorPaint);
        }
        ...
        for(int r = 0; r < 10; r++){
            ...
            canvas.drawLine(0,cellSize * r, getWidth(),cellSize * r,
                    boardColorPaint);
        }
